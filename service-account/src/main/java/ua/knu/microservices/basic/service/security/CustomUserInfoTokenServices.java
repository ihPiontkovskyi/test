...
public class CustomUserInfoTokenServices implements ResourceServerTokenServices {
    ...
    private OAuth2Authentication extractAuthentication(Map<String, Object> map) {
        ...
        OAuth2Request request = new OAuth2Request(null, this.clientId, authorities, true, null, null, null, null, null);
    ...
    private Map<String, Object> getMap(String path, String accessToken) {
        ...
        try {
            OAuth2RestOperations ex = this.restTemplate;
            if (ex == null) {
            ...
            OAuth2AccessToken existingToken1 = ex.getOAuth2ClientContext().getAccessToken();
            if (existingToken1 == null || !accessToken.equals(existingToken1.getValue())) {
                DefaultOAuth2AccessToken token = new DefaultOAuth2AccessToken(accessToken);
                token.setTokenType(this.tokenType);
                ex.getOAuth2ClientContext().setAccessToken(token);
            }

            return (Map<String, Object>) ex.getForEntity(path, Map.class, new Object[0]).getBody();
